...
class HomeModel {
  ...
  HomeModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['bannerList'] != null) {
      bannerList = new List<BannerListModel>();
      json['bannerList'].forEach((v) {
        bannerList.add(new BannerListModel.fromJson(v));
      });
    }
    if (json['localNavList'] != null) {
      localNavList = new List<LocalNavListModel>();
      json['localNavList'].forEach((v) {
        localNavList.add(new LocalNavListModel.fromJson(v));
      });
    }
    gridNav =
        json['gridNav'] != null ? new GridNavModel.fromJson(json['gridNav']) : null;
    if (json['subNavList'] != null) {
      subNavList = new List<SubNavListModel>();
      json['subNavList'].forEach((v) {
        subNavList.add(new SubNavListModel.fromJson(v));
      });
    }
...
class LocalNavListModel {
  ...
  LocalNavListModel.fromJson(Map<String, dynamic> json) {
    icon = json['icon'];
    title = json['title'];
    url = json['url'];
...
class GridNavItem {
  ...
  GridNavItem.fromJson(Map<String, dynamic> json) {
    ...
    mainItem = json['mainItem'] != null
        ? new MainItemModel.fromJson(json['mainItem'])
        : null;
    item1 = json['item1'] != null ? new ItemModel.fromJson(json['item1']) : null;
    item2 = json['item2'] != null ? new ItemModel.fromJson(json['item2']) : null;
    item3 = json['item3'] != null ? new ItemModel.fromJson(json['item3']) : null;
    item4 = json['item4'] != null ? new ItemModel.fromJson(json['item4']) : null;
  }
...
class MainItemModel {
  ...
  MainItemModel.fromJson(Map<String, dynamic> json) {
    title = json['title'];
    icon = json['icon'];
    url = json['url'];
    statusBarColor = json['statusBarColor'];
...
class ItemModel {
  ...
  ItemModel({this.title, this.url, this.statusBarColor});
...
class SalesBoxModel {
  ...
  CardModel bigCard1;
  CardModel bigCard2;
  CardModel smallCard1;
  CardModel smallCard2;
  CardModel smallCard3;
  CardModel smallCard4;
  ...
  SalesBoxModel.fromJson(Map<String, dynamic> json) {
    ...
    bigCard1 = json['bigCard1'] != null
        ? new CardModel.fromJson(json['bigCard1'])
        : null;
    bigCard2 = json['bigCard2'] != null
        ? new CardModel.fromJson(json['bigCard2'])
        : null;
    smallCard1 = json['smallCard1'] != null
        ? new CardModel.fromJson(json['smallCard1'])
        : null;
    smallCard2 = json['smallCard2'] != null
        ? new CardModel.fromJson(json['smallCard2'])
        : null;
    smallCard3 = json['smallCard3'] != null
        ? new CardModel.fromJson(json['smallCard3'])
        : null;
    smallCard4 = json['smallCard4'] != null
        ? new CardModel.fromJson(json['smallCard4'])
        : null;
  }
...
class CardModel {
  ...
  CardModel({this.icon, this.url, this.title, this.statusBarColor, this.hideAppBar});
