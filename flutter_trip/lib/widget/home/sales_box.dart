...
//   final List<SalesBoxModel> salesBox;
...
//       List<Widget> items = [];
//       items.add(_doublueItem(context));
//     }

//     Widget _doublueItem(BuildContext context, CardModel leftCard, CardModel rightCard, bool isbig, bool islast) {
...
class SalesBox extends StatelessWidget {
  ...
  Widget _doubleItem(BuildContext context, CardModel leftCard,
      CardModel rightCard, bool big, bool last) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: <Widget>[
  ...
  Widget _item(
    BuildContext context, CardModel model, bool big, bool left, bool last) {
