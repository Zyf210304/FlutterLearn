...
class GrowTransition extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Center(
        child: Column(
          ...
          Text('value:' + animationStatus.toString(),
              textDirection: TextDirection.ltr,
...
class _LogoAppState extends State<LogoApp> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    //       ),
    //       Text('state:' + controller.value.toString(), textDirection: TextDirection.ltr, style: TextStyle(color: Colors.red),),
    //       Text('value:' + controller.value.toString(), textDirection: TextDirection.ltr,style: TextStyle(color: Colors.blue)),
    //       Container(
    //         height: animation.value,
    //         width: animation.value,
    //         child: FlutterLogo(),
    ...
    return Container(
      child: Column(
        children: <Widget>[
          ...
          // Text(
          //   'state:' + animation.value.toString(),
          //   textDirection: TextDirection.ltr,
          //   style: TextStyle(color: Colors.red),
          // ),
          // Text('value:' + animation.value.toString(),
          //     textDirection: TextDirection.ltr,
          //     style: TextStyle(color: Colors.blue)),
          GrowTransition(
            animation: animation,
